...
import { saveUserSession } from './database.js';
...
async function handleSignup(btn) {
    ...
    try {
        ...
        // Get professor data and save session after signup
        ...
        openCurtainsAndRedirect('prof/index.html');
    } catch (err) {
...
async function handleLogin(btn) {
    ...
    try {
        ...
        // Create a Supabase Auth session so RLS policies work
